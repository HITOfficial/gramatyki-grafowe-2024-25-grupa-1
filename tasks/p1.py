from GramatykiGrafowe import Node, Graph
...
def transition(g: Graph, get_node):
    ...
    q2 = Node(label = 'Q', x = (v12.x + v2.x) / 2, y = (v2.y + v23.y) / 2)
    q3 = Node(label = 'Q', x = (v3.x + v34.x) / 2, y = (v23.y + v3.y) / 2)
    ...
    edges = [
        (v1, v12), (v12, v2), (v2, v23), (v23, v3), (v3, v34), (v34, v4), (v4, v41), (v41, v1),
        (q1, v1), (q1, v12), (q1, v_center), (q1, v41),
        (q2, v12), (q2, v2), (q2, v23), (q2, v_center),
        (q3, v_center), (q3, v23), (q3, v3), (q3, v34),
        (q4, v41), (q4, v_center), (q4, v34), (q4, v4),
        (v_center, v12), (v_center, v23), (v_center, v34), (v_center, v41)
    ]
